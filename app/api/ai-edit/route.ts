...
export async function POST(request: Request) {
  try {
    ...
    const prompt = hairstyleOnly
      ? `Edit image 1 using image 2 exclusively as a HAIR-SHAPE TEMPLATE. Image 2 contains no person and no usable face identity: its white facial opening is an empty hole. Ignore and never copy, reconstruct, infer, or use any eyebrows, ears, skin, jewelry, facial outline, facial proportions, or apparent person detail from image 2. HAIR-ONLY EDIT: replace only the existing hair pixels and the minimum necessary immediately adjacent hair-edge pixels. Match image 2 exactly in parting position, fringe or exposed forehead, silhouette, length, layers, volume, direction, tuck behind ears, tied or loose arrangement, and strand flow. Do not substitute a generic hairstyle. Fit that exact hair shape naturally around the completely unchanged face from image 1. The person and identity must come exclusively from image 1. Contour the hair around the original forehead, temples, cheeks, jaw, and ears without moving, narrowing, widening, reshaping, covering, repainting, or regenerating any facial feature. Apply a professional natural-black hair tone at 50% intensity, similar to subtle Black Pro 50%: deepen only the hair toward rich neutral black while retaining dark-brown and charcoal micro-variation, individual strands, translucent edge hairs, natural roots, gravity, flyaways, and soft non-uniform camera highlights. Never recolor eyebrows or eyelashes, and never make hair flat jet-black, overly smooth, glossy plastic, painted, pasted, helmet-like, or wig-like. ABSOLUTE PIXEL LOCK OUTSIDE HAIR: preserve the exact original identity, face, expression, facial geometry, skin and texture, complexion, ears, eyebrows, eyes, nose, lips, jaw, head size, neck, shoulders, arms, body proportions, selected outfit, fabric, pose, transparent background, lighting, exposure, shadows, white balance, canvas dimensions, crop, camera perspective, position, and person scale. Never retouch, smooth, brighten, whiten, recolor, relight, denoise, add makeup, beautify, crop, zoom, move, resize, or regenerate any non-hair area. The output must be a transparent-background PNG of the same genuine photograph with only the selected hairstyle changed.`
      : outfitChange
