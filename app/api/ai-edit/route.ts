...
export async function POST(request:Request){
  try{
    ...
    // Official mode never uploads the real government-uniform template to AI.
    // It is composited locally after the AI returns the person layer.
...
- The government-uniform template is NOT sent to the AI. The website composites the exact real PNG template after this AI call, so do not create any clothing or shoulders.
${useHairstyleReference?"- Image 2 = the EXACT selected hairstyle reference. It is authoritative for the hairstyle design.":""}
...
The exact government-uniform geometry is handled locally by the website after this call. Produce only a natural head/hair/neck layer with enough clean margin for deterministic fitting.
